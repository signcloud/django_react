...
#     def _create_user(self, username, email, password, first_name, last_name, mobile, **extra_fields):
#         if not email:
...
#         default=True)  # must be needed, otherwise you won't be able to login to django-admin.
